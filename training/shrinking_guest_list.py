...
print("\nWe actually only have room for two!")

revoke_invitee = guests.pop()
print(f"\nSorry {revoke_invitee.title()}, we can't invite you to dinner.")

revoke_invitee = guests.pop()
print(f"Sorry {revoke_invitee.title()}, we can't invite you to dinner.")
...
print(f"\n{guests[0].title()}, you're still invited to dinner!")
